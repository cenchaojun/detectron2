...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", default='/data/cenzhaojun/detectron2/training_dir/cascade_mask_rcnn_R_50_FPN_1x/inference/coco_instances_results.json',help="JSON file produced by the model")
    parser.add_argument("--output", default='/data/cenzhaojun/detectron2/training_dir/cascade_mask_rcnn_R_50_FPN_1x/inference/output', help="output directory")
